    ...
    return _then(_value.copyWith(
      ...
      publishedAt: null == publishedAt
          ...
          : publishedAt // ignore: cast_nullable_to_non_nullable
              as String,
      bodyUpdatedAt: null == bodyUpdatedAt
...
/// @nodoc
abstract class _$$ZennArticleImplCopyWith<$Res>
    implements $ZennArticleCopyWith<$Res> {
  factory _$$ZennArticleImplCopyWith(
          _$ZennArticleImpl value, $Res Function(_$ZennArticleImpl) then) =
      __$$ZennArticleImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$ZennArticleImplCopyWithImpl<$Res>
    extends _$ZennArticleCopyWithImpl<$Res, _$ZennArticleImpl>
    implements _$$ZennArticleImplCopyWith<$Res> {
  __$$ZennArticleImplCopyWithImpl(
      _$ZennArticleImpl _value, $Res Function(_$ZennArticleImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ZennArticleImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$ZennArticleImpl implements _ZennArticle {
  const _$ZennArticleImpl(
      {required this.id,
  ...
  factory _$ZennArticleImpl.fromJson(Map<String, dynamic> json) =>
      _$$ZennArticleImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ZennArticleImplCopyWith<_$ZennArticleImpl> get copyWith =>
      __$$ZennArticleImplCopyWithImpl<_$ZennArticleImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ZennArticleImplToJson(
      this,
    );
  }
}
...
abstract class _ZennArticle implements ZennArticle {
  const factory _ZennArticle(
      ...
      required final Map<String, dynamic> user}) = _$ZennArticleImpl;

  factory _ZennArticle.fromJson(Map<String, dynamic> json) =
      _$ZennArticleImpl.fromJson;
