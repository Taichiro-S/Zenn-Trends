...
part of 'notion_integrate_webview_state.dart';
...
class _$NotionIntegrateWebViewStateImpl
  ...
  @override
  String toString() {
    return 'NotionIntegrateWebViewState(isOpen: $isOpen, isLoading: $isLoading, isError: $isError, errorText: $errorText)';
  }
...
abstract class _NotionIntegrateWebViewState
  ...
  const factory _NotionIntegrateWebViewState(
      ...
      required final String errorText}) = _$NotionIntegrateWebViewStateImpl;
